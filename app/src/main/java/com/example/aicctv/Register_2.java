...
public class Register_2 extends AppCompatActivity {
        ...
        confirm_button.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view) {
                if (selectedUriList!= null&&editText_name!=null) {
                    final ProgressDialog progressDialog = new ProgressDialog(Register_2.this);
        ...
        btnMultiShow.setOnClickListener(view -> {
            ...
            PermissionListener permissionlistener = new PermissionListener() {
                ...
                public void onPermissionGranted() {
                    TedBottomPicker.with(Register_2.this)
                ...
                public void onPermissionDenied(ArrayList<String> deniedPermissions) {
                    Toast.makeText(Register_2.this, "Permission Denied\n" + deniedPermissions.toString(), Toast.LENGTH_SHORT).show();
                }
            };
    ...
    private void checkPermission(PermissionListener permissionlistener) {
        TedPermission.with(Register_2.this)
