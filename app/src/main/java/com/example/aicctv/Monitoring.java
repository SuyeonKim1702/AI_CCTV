...
import static java.io.File.createTempFile;
    ...
    public class Monitoring extends AppCompatActivity {
        ...
        public void downloadVideo(StorageReference videoRef){
            try {
                localFile = createTempFile("img",".h264");
                videoRef.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                        ...
                        try {
                            ...
                            h264Track = new H264TrackImpl(new FileDataSourceImpl(localFile));
                            Movie movie = new Movie();
                            movie.addTrack(h264Track);

                            Container out = new DefaultMp4Builder().build(movie);
                            FileChannel fc = new FileOutputStream(new File(videopath, videoname)).getChannel();
